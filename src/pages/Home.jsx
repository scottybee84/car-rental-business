  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "Rent a Tesla Model Y in Germany - Designed for U.S. Travelers. English support, Frankfurt Airport pickup, simple charging.",
        address: {
          "@type": "PostalAddress",
      ...
      },
      {
        ...
        description:
          "2024 Tesla Model Y rental in Germany. Perfect for U.S. travelers with English support and Frankfurt Airport pickup.",
        brand: {
          "@type": "Brand",
          name: "Tesla",
        },
      ...
      },
      {
        ...
        potentialAction: {
          ...
          target: {
            "@type": "EntryPoint",
            urlTemplate:
              "https://voltvoyages.com/search?q={search_term_string}",
          },
