  ...
  const benefits = [
    {
      ...
      description: 'All communication in English. No language barriers when you need help.'
    },
    {
      title: 'Easy pickup at Frankfurt Airport',
      description: 'Convenient airport location. We meet you at the terminal for a seamless start to your trip.'
    },
    {
      title: 'Simple charging instructions for German roads',
      description: 'Clear, easy-to-follow guide on where and how to charge your Tesla throughout Germany.'
    }
  ];
    ...
    <section className="section">
      <div className="content-wrapper">
        <div className="heading-580px centered">
          ...
          <h2 className="centered-heading">Why Americans Love Renting With Us</h2>
        </div>
