            ...
            <div className="footer-info-wrapper">
              <div className="footer-info-top">
                <div className="footer-links-wrapper">
                  ...
                  <div className="footer-links">
                    <a
                      href="mailto:hello@voltvoyage.com"
                      className="ghost-link-pure-small w-inline-block"
                    >
                      <div className="clip">
                        <div className="link-text-wrapper">
                          <div>hello@voltvoyage.com</div>
                        </div>
                        <div className="link-text-wrapper link-text-bottom">
                          <div>hello@voltvoyage.com</div>
                        </div>
                    ...
                    <a
                      href="https://maps.google.com/?q=Hauptstraße+12,+64720+Michelstadt,+Germany"
                      className="ghost-link-pure-small w-inline-block"
                    >
                      <div className="clip">
                        <div className="link-text-wrapper">
                          <div>Hauptstraße 12, 64720 Michelstadt, Germany</div>
                        </div>
                        <div className="link-text-wrapper link-text-bottom">
                          <div>Hauptstraße 12, 64720 Michelstadt, Germany</div>
                        </div>
